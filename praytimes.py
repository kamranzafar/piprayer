...
class PrayTimes():
    ...
    asrMethods = {'Standard': 1, 'Hanafi': 2}
    ...
    def __init__(self, method="MWL", asrMethod="Standard"):
        ...
        if asrMethod in self.asrMethods:
            self.settings['asr'] = asrMethod
    ...
    def asrFactor(self, asrParam):
        return self.asrMethods[asrParam] if asrParam in self.asrMethods else self.eval(asrParam)
